    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Washer time summary</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <div class="row">
                                <div class="col-sm-3">
                                    <h4 class="m-t-0 header-title"><b>Time summary</b></h4>
                                </div>
                                <div class="col-sm-9">
...
function onChangeDate()
{
    ...
    table.ajax.url("<?php echo site_url('Cms_api/get_washer_time_summary/')?>" +         
        "/" + startDt + 
        "/" + endDt);
    reload_table();    
}
