    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Manage Specials</h4>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Specials</b></h4>
...
<script type="text/javascript">
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/get_specials')?>",
                type: "POST",
            },
        })
    },
