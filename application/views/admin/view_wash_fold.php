    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">WashFold Transactions</h4>
...
function onClearHistory()
{
        swal({
            ...
            if(isConfirm) {
                $.post("<?php echo site_url('Cms_api/clearWashFoldHistory')?>", function(data){
                    window.location = "<?php echo site_url('Cms/washfold/')?>";
                });
            }
        });
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/getWashFold')?>",
                type: "POST",
            },
        })
    },
