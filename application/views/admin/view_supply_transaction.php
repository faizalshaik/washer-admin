    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Supply Transactions</h4>
                        ...
                        <div class="widget-bg-color-icon card-box fadeInDown animated">
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 text-center">
                                        <h3 class="text-dark"><b class="counter"><?php echo '$ '.$cash; ?></b></h3>
                                        <p class="text-muted">Cash</p>
                                    </div>
                                    <div class="col-lg-2 text-center">
                                        <h3 class="text-dark"><b class="counter"><?php echo '$ '.$credit; ?></b></h3>
...
function onClearHistory()
{
        swal({
            ...
            if(isConfirm) {
                $.post("<?php echo site_url('Cms_api/clearSupplyTransactionHistory')?>", function(data){
                    window.location = "<?php echo site_url('Cms/supplyTransaction/')?>";
                });
            }
        });
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/getSupplyTransaction')?>",
                type: "POST",
            },
        })
    },
