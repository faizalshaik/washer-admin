    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Manage Option Service</h4>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Option Services</b></h4>
                    ...
                    <div class="col-sm-3">
                        <div class="card-box">
                            ...
                            <form action="<?php echo base_url().'Cms_api/edit_option'?>" data-parsley-validate novalidate method="post" enctype="multipart/form-data">
                                <input type="hidden" name="optionId" id="optionId">

                                <div class="form-group">
                                    <label for="price">Name</label>
                                    <input type="text" id="optionName" name="optionName" parsley-trigger="change" required placeholder="Enter Name" 
                                        class="form-control">
                                </div>
...
<script type="text/javascript">
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/get_options')?>",
                type: "POST",
            },
        })
    },
