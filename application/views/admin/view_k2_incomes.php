    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Kiosk2 Transactions</h4>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="widget-bg-color-icon card-box fadeInDown animated">
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-lg-2 text-center">
                                        <h3 class="text-dark"><b class="counter"><?php echo '$ '.$total_payout; ?></b></h3>
                                        <p class="text-muted">Total Payout</p>
                                    </div>
                                    <?php foreach($payouts as $bill=>$counter) { ?>
                                        <div class="col-lg-1 text-right">
                                            <h3 class="text-dark"><b class="counter"><?php echo $counter; ?></b></h3>
                                            <p class="text-muted"><?php echo '$ '.$bill; ?></p>
                                        </div>
...
function onClearHistory()
{
       swal({
            ...
            if(isConfirm) 
            {
                $.post("<?php echo site_url('Cms_api/clearHomeSaleHistory')?>", function(data){
                    window.location = "<?php echo site_url('Cms/k2_incomes/')?>";
                });
            }
        });
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/getKiosk2Incomes')?>",
                type: "POST",
            },
        })
    },
