    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="page-title">Dryer time details</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <div class="row">
                                <div class="col-sm-3">
                                    <h4 class="m-t-0 header-title"><b>Dryer time details</b></h4>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="washers" class="col-sm-4 control-label">Washer:</label>
                                        <div class="col-sm-7">
...
function onSelectWasher(obj)
{
    ...
    var handleDataTableButtonsMatch = function() {
        tableMatch = $("#datatable-match").DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('Cms_api/get_dryer_time_details')?>",
                type: "POST",
            },
        })
    },
