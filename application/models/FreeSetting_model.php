...
class FreeSetting_model extends CI_Model {

	public function __construct()
	{
		parent::__construct();
		$this->tblName = 'tbl_free_setting';
	}
	...
	public function getDatasDesc($conAry, $orderBy='') 
	{
		$this->db->from($this->tblName);
	...
	{
		$bonus = 0;
		$promos = $this->getDatas(null, 'price');
		foreach($promos as $promo)
		{
			if($price < $promo->price)
				break;
			$bonus = $promo->bonus;
		}
		return $bonus; 
